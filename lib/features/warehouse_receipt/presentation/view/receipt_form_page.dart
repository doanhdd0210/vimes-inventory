...
/// Data-entry screen for a Phiếu nhập kho. Returns the saved id via
/// `Navigator.pop` on success so the caller can refresh the list.
class ReceiptFormPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          ReceiptFormBloc(createWarehouseReceipt: sl<CreateWarehouseReceipt>()),
